module.exports = {
  ...
  article: {
    title: 'hello world',
    body:
      'ejej lkejke lkejde eljfe kefnef efnefve lkenfefenf kefnerjfnern elkfnrfernflef elkfnejfernf lefnerfe kefnrefne klekfnerfefnlef ekfnefnerel nefefnef efnefklnef kenfefnef kenferfn',
    tagList: [],
  },
  draftJsContentState: {
    blocks: [
